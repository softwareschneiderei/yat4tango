...
//=============================================================================
//! \brief YAT_EXCEPTION_TO_LOG_STREAM MACRO
//!
//! \param _yat_ex The yat exception.
//=============================================================================
#define YAT_EXCEPTION_TO_LOG_STREAM(_yat_ex) \
  ...
  { \
    ...
    { \
      case yat::WARN: \
        WARN_STREAM << el[i].reason << ". " << el[i].desc << ". " << el[i].origin << ENDLOG; \
        break; \
      case yat::PANIC: \
        FATAL_STREAM << el[i].reason << ". " << el[i].desc << ". " << el[i].origin << ENDLOG; \
        break; \
      case yat::ERR: \
      default: \
...
//! \param _tango_ex The corresponding Tango exception.
//=============================================================================
#define TANGO_EXCEPTION_TO_LOG_STREAM(_tango_ex) \
